...
-(void) addSongToFirebasePlaylist: (UIButton *)button {
    ...
    [[newPushSongRef childByAppendingPath:modelToSend.title] setValue:modelToSend.link[0]];
   ...
   // linkUsers = [linkUsers stringByAppendingString:self.thisPlaylist.name];
    ...
    NSLog(@"Playlist name:%@",self.thisPlaylist.name);
    ...
    [[userRef childByAppendingPath:modelToSend.title] setValue:modelToSend.link[0]];
